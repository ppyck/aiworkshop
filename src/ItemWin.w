...
DO:
  ...
  IF lFound THEN
  DO:
     /* Find item in temp-table and display */
...
DO:
  ...
  IF lFound THEN
  DO:
     /* Find item in temp-table and update price */
     FIND FIRST ttItem NO-ERROR.
     IF AVAILABLE ttItem THEN
     DO:
        ...
        /* Validate item data */
        lValid = objItemEntity:ValidateItem(INPUT-OUTPUT DATASET dsItem, OUTPUT cErrorMessage).
